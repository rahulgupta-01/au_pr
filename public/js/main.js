document.addEventListener('DOMContentLoaded', () => {
    ...
    function initializeDashboard() {
        ...
        function updateMetrics() {
            ...
            const extensionApplied = new Date(extensionMilestone.date) <= todayForCalculations;
        ...
        function renderTimeline(filter = 'all') {
            ...
            timelineEl.innerHTML = `<div id="timeline-progress-fill" style="height: ${progressPercent}%"></div>` + visibleMilestones
                .map(m => {
                    ...
                    // Force Perth timezone for consistent date display
